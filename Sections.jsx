...
const MarketplaceSection = () => {
  ...
  return (
    <Section id="marketplace" eyebrow="Accès" title="Votre engagement ouvre des accès." sub="Ici, on n'achète rien : on ouvre des portes grâce à ce que l'on a apporté au commun. Ateliers, formations, nuits en écolieu, savoir-faire partagés par les lieux du réseau. La valeur reste sur le territoire.">
