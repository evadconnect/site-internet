...
const NEWSLETTER_BY_ROLE = {
  ...
  batisseur: {
    ...
    pitch: "Recevez les quêtes ouvertes près de chez vous, les nouveaux lieux à découvrir et les bons plans du réseau. Un email par saison, sans tracker.",
  ...
  semeur: {
    ...
    pitch: "Recevez chaque saison les chiffres du réseau : contributions en circulation, quêtes accomplies, preuves validées, Vadité des lieux. De quoi orienter vos financements en toute connaissance.",
