...
const PILLARS = [
  ...
  },
  {
    ...
    title: 'Gamification',
    pitch: "Des mécaniques de jeu au service de l'impact : quêtes, preuves, graines et REGEN score transforment chaque action en progression collective tangible et célébrée.",
    bullets: [],
    bg: '#0d2b22',
    accent: '#3a6e8c',
    visual: () => (
